...
const Hero = () => {
  return (
    <section className="min-h-[90vh] flex flex-col items-center justify-center text-center px-4 pt-20 pb-10">
      <div className="relative mb-8 w-full max-w-4xl mx-auto flex justify-center">
        <img
          src="/hero-title.svg"
          alt="דוידקה"
          className="w-full h-auto max-w-[300px] md:max-w-full drop-shadow-[0_0_15px_rgba(58,162,219,0.5)]"
        />
      </div>
